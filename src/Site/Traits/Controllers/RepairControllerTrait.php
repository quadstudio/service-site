...
use QuadStudio\Service\Site\Filters\Difficulty\ActiveFilter As DifficultyActiveFilter;
use QuadStudio\Service\Site\Filters\Distance\ActiveFilter As DistanceActiveFilter;
...
trait RepairControllerTrait
{
    ...
    public function create(RepairRequest $request)
    {
        ...
        $types = $this->types->all();
        $difficulties = $this->difficulties->applyFilter(new DifficultyActiveFilter())->all();
        $distances = $this->distances->applyFilter(new DistanceActiveFilter())->all();
