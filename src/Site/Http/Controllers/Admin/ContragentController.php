...
use QuadStudio\Service\Site\Exports\Excel\ContragentExcel;
use QuadStudio\Service\Site\Filters\Contragent\ContragentPerPageFilter;
use QuadStudio\Service\Site\Filters\Contragent\ContragentUserFilter;
...
class ContragentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $this->contragents->pushTrackFilter(ContragentUserFilter::class);
