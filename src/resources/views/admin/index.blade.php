                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.currencies.index') }}">
                                    <i class="fa fa-@lang('site::currency.icon')"></i> @lang('site::currency.currencies')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.currency_archives.index') }}">
                                    <i class="fa fa-@lang('site::archive.icon')"></i> @lang('site::archive.archives')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.warehouses.index') }}">
                                    <i class="fa fa-@lang('site::warehouse.icon')"></i> @lang('site::warehouse.warehouses')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.organizations.index') }}">
                                    <i class="fa fa-@lang('site::organization.icon')"></i> @lang('site::organization.organizations')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.banks.index') }}">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.distances.index') }}">
                                    <i class="fa fa-@lang('site::distance.icon')"></i> @lang('site::distance.distances')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.difficulties.index') }}">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.blocks.index') }}">
                                    <i class="fa fa-@lang('site::block.icon')"></i> @lang('site::block.blocks')
                                </a>

                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.schemes.index') }}">
                                    <i class="fa fa-@lang('site::scheme.icon')"></i> @lang('site::scheme.schemes')
                                </a>

                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.elements.index') }}">
                        ...
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.product_types.index') }}">
                                    <i class="fa fa-@lang('site::product_type.icon')"></i> @lang('site::product_type.product_types')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.file_groups.index') }}">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.authorization-types.index') }}">
                                    <i class="fa fa-@lang('site::authorization_type.icon')"></i> @lang('site::authorization_type.authorization_types')
                                </a>
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.authorization-brands.index') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.mountings.index') }}"><i
                                            class="fa fa-@lang('site::mounting.icon')"></i> @lang('site::mounting.mountings')</a>
                        ...
                        <div class="col-md-6">
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.news.index') }}">
                                ...
                                <a class="list-group-item list-group-item-action py-1" href="{{ route('admin.members.index') }}">
