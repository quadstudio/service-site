                    ...
                    <div class="card-body">
                        <form method="POST" id="block-edit-form"
                            ...
                            <div class=" text-right">
                                <button name="_stay" form="block-edit-form" value="1" type="submit" class="btn btn-ferroli">
                                    <i class="fa fa-check"></i>
                                    <span>@lang('site::messages.save_stay')</span>
                                </button>
                                <button name="_stay" form="block-edit-form" value="0" type="submit" class="btn btn-ferroli">
                                    <i class="fa fa-check"></i>
