        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        @if($user->orders()->count() > 0)
                            ...
                            <span class="text-muted">@lang('site::repair.help.last')
                                :</span>&nbsp;&nbsp;{{ $user->repairs()->latest()->first()->created_at(true) }}
                            </div>
                        @endif
                        @if($user->orders()->count() > 0)
                            <div class="mb-2">
                            <span class="text-muted">@lang('site::order.help.last')
                                :</span>&nbsp;&nbsp;{{ $user->orders()->latest()->first()->created_at(true) }}
                            </div>
                        @endif
                        <div class="mb-2">
            ...
            <div class="col">
                <div class="row no-gutters text-center mb-4">
                    ...
                    <a href="{{route('admin.users.addresses', $user)}}" class="d-flex border col flex-column text-dark py-3">
                        <div class="font-weight-bold">{{$user->addresses()->count()}}</div>
                        <div class="text-muted ">@lang('site::address.addresses')
                        </div>
                    </a>
                </div>
                <div class="row no-gutters text-left mb-4">
                    <div class="card mb-2">
                        <div class="card-body">
