...
@section('content')
    <div class="container">
        ...
        <h1 class="header-title m-t-0 m-b-20"><i class="fa fa-@lang('site::contragent.icon')"></i> @lang('site::contragent.contragents')</h1>
        @alert()@endalert()
        <div class="row">
            <div class="col-sm-12">
                {{$items->render()}}
        ...
        <div class="row">
            <div class="col-12">
                <table class="table table-hover table-sm">
                    ...
                    <tbody>
                    @each('site::contragent.index.row', $items, 'contragent')
                    </tbody>
                </table>
            </div>
        </div>
