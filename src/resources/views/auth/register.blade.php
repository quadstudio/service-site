                ...
                <form id="register-form" method="POST" action="{{ route('register') }}">
                                    ...
                                    @foreach($types as $key => $type)
                                        <div class="custom-control custom-radio">
                                            ...
                                            {{$errors->has('type_id') ? ' is-invalid' : ''}}"
                                                   ...
                                                   id="type_id_{{ $type->id }}"
                                                   value="{{ $type->id }}">
                                            <label class="custom-control-label" for="type_id_{{ $type->id }}">{{ $type->name }}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="contact_position">@lang('site::contact.position')</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-row required">
                                <div class="col mb-3">
                                    ...
                                    <label class="control-label" for="phone_contact_country_id">@lang('site::phone.country_id')</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-row required">
                                <div class="col">
                                    <label class="control-label" for="phone_contact_number">@lang('site::phone.number')</label>
                                    <input type="text"
                        ...
                        <div class="col-md-3">
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="phone_contact_extra">@lang('site::phone.extra')</label>
                                    <input type="text"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    ...
                                    <label class="control-label" for="phone_user_country_id">@lang('site::phone.country_id')</label>
                                    <select class="form-control{{  $errors->has('phone.user.country_id') ? ' is-invalid' : '' }}"
                                        ...
                                        @foreach($countries as $country)
                                            <option
                                                    @if(old('phone.user.country_id') == $country->id) selected
                                                    @endif
                                                    value="{{ $country->id }}">{{ $country->name }}
                                                ({{ $country->phone }})
                                            </option>
                                    ...
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('phone.user.country_id') }}</strong>
                                    </span>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-row required">
                                        <div class="col">
                                            <label class="control-label" for="phone_user_number">@lang('site::phone.number')</label>
                                            <input type="tel"
                                                   required
                                                   ...
                                                   pattern="^\d{10}$"
                                                   maxlength="10"
                                                   class="form-control{{ $errors->has('phone.user.number') ? ' is-invalid' : '' }}"
                                                   placeholder="@lang('site::phone.placeholder.number')"
                                                   value="{{ old('phone.user.number') }}">
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('phone.user.number') }}</strong>
                                            </span>
                                            <small id="user_phone_numberHelp"
                                ...
                                <div class="col-md-6">
                                    <div class="form-row">
                                        <div class="col mb-3">
                                            <label class="control-label" for="phone_user_extra">@lang('site::phone.extra')</label>
                                            <input type="text"
                                                   name="phone[user][extra]"
                                                   id="phone_user_extra"
                                                   class="form-control{{ $errors->has('phone.user.extra') ? ' is-invalid' : '' }}"
                                                   placeholder="@lang('site::phone.placeholder.extra')"
                                                   value="{{ old('phone.user.extra') }}">
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('phone.user.extra') }}</strong>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    ...
                                    <label class="control-label" for="address_user_country_id">@lang('site::address.country_id')</label>
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    ...
                                    <label class="control-label" for="address_user_region_id">@lang('site::address.region_id')</label>
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="address_user_locality">@lang('site::address.locality')</label>
                                    <input type="text"
                                    ...
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('address.user.locality') }}</strong>
                                    </span>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="address_user_street">@lang('site::address.street')</label>
                                    <input type="text"
                                           name="address[user][street]"
                                           id="address_user_street"
                                           class="form-control{{ $errors->has('address.user.street') ? ' is-invalid' : '' }}"
                                           placeholder="@lang('site::address.placeholder.street')"
                                           value="{{ old('address.user.street') }}">
                                    <span class="invalid-feedback">
                                        <strong>{{ $errors->first('address.user.street') }}</strong>
                                    </span>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-row required">
                                        <div class="col mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('address.user.building') }}">
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('address.user.building') }}</strong>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-row">
                                        <div class="col mb-3">
                                            <label class="control-label"
                                                   for="address_user_apartment">@lang('site::address.apartment')</label>
                                            <input type="text"
                                                   name="address[user][apartment]"
                                                   id="address_user_apartment"
                                                   class="form-control{{ $errors->has('address.user.apartment') ? ' is-invalid' : '' }}"
                                                   placeholder="@lang('site::address.placeholder.apartment')"
                                                   value="{{ old('address.user.apartment') }}">
                                            <span class="invalid-feedback">
                                                <strong>{{ $errors->first('address.user.apartment') }}</strong>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_type_id">@lang('site::contragent.type_id')</label>
                                    @foreach($types as $key => $type)
                        ...
                        <div class="col-md-6">
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_nds">@lang('site::contragent.nds')</label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input
                                            {{$errors->has('contragent.nds') ? ' is-invalid' : ''}}"
                                               ...
                                               id="contragent_nds_1"
                                               value="1">
                                        <label class="form-check-label" for="contragent_nds_1">@lang('site::messages.yes')</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input
                                            {{$errors->has('contragent.nds') ? ' is-invalid' : ''}}"
                                               ...
                                               id="contragent_nds_0"
                                               value="0">
                                        <label class="form-check-label" for="contragent_nds_0">@lang('site::messages.no')</label>
                                        <span class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_inn">@lang('site::contragent.inn')</label>
                                    <input type="number"
                                           name="contragent[inn]"
                                           id="contragent_inn"
                                           maxlength="12"
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_ogrn">@lang('site::contragent.ogrn')</label>
                                    <input type="number"
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_okpo">@lang('site::contragent.okpo')</label>
                                    <input type="number"
                            ...
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_kpp">@lang('site::contragent.kpp')</label>
                                    <input type="number"
                                           name="contragent[kpp]"
                                           id="contragent_kpp"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_rs">@lang('site::contragent.rs')</label>
                                    <input type="number"
                                           name="contragent[rs]"
                                           required
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_bik">@lang('site::contragent.bik')</label>
                                    <input type="number"
                                           name="contragent[bik]"
                                           id="contragent_bik"
                                           required
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_bank">@lang('site::contragent.bank')</label>
                                    <input type="text"
                            ...
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="contragent_ks">@lang('site::contragent.ks')</label>
                                    <input type="number"
                                           name="contragent[ks]"
                                           id="contragent_ks"
                                           maxlength="20"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <input type="hidden"
                                           ...
                                           value="1">
                                    <label class="control-label" for="address_legal_country_id">@lang('site::address.country_id')</label>
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    ...
                                    <label class="control-label" for="address_legal_region_id">@lang('site::address.region_id')</label>
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="address_legal_locality">@lang('site::address.locality')</label>
                                    <input type="text"
                            ...
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="address_legal_street">@lang('site::address.street')</label>
                                    <input type="text"
                            ...
                            <div class="row required">
                                <div class="col-md-6">
                                    <div class="form-row ">
                                        <div class="col mb-3">
                                            <label class="control-label" for="address_legal_building">@lang('site::address.building')</label>
                                            <input type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-row">
                                        <div class="col mb-3">
                                            <label class="control-label" for="address_legal_apartment">@lang('site::address.apartment')</label>
                                            <input type="text"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <input type="hidden"
                                           ...
                                           value="3">
                                    <label class="control-label" for="address_postal_country_id">@lang('site::address.country_id')</label>
                            ...
                            <div class="form-row required">
                                <div class="col mb-3 required">
                                    ...
                                    <label class="control-label" for="address_postal_region_id">@lang('site::address.region_id')</label>
                            ...
                            <div class="form-row required">
                                <div class="col mb-3">
                                    <label class="control-label" for="address_postal_locality">@lang('site::address.locality')</label>
                                    <input type="text"
                            ...
                            <div class="form-row">
                                <div class="col mb-3">
                                    <label class="control-label" for="address_postal_street">@lang('site::address.street')</label>
                                    <input type="text"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-row required">
                                        <div class="col mb-3">
                                            <label class="control-label" for="address_postal_building">@lang('site::address.building')</label>
                                            <input type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-row">
                                        <div class="col mb-3">
                                            <label class="control-label" for="address_postal_apartment">@lang('site::address.apartment')</label>
                                            <input type="text"
                    ...
                    <div class="form-row required">
                        <div class="col mb-3">
                            <label class="control-label" for="password-confirmation">@lang('site::user.password_confirmation')</label>
