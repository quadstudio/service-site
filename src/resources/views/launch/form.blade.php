<form id="form-content" method="POST" action="{{ route('launches.store') }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-row">
                <div class="col mb-3">
                    <label for="document_name">@lang('repair::launch.document_name')</label>
                    <input type="text" name="document_name" id="document_name"
                           class="form-control{{ $errors->has('document_name') ? ' is-invalid' : '' }}"
                           placeholder="@lang('repair::launch.placeholder.document_name')"
            ...
            <div class="form-row">
                <div class="col mb-3">
                    <label for="document_number">@lang('repair::launch.document_number')</label>
                    <input type="text" name="document_number" id="document_number"
                           class="form-control{{ $errors->has('document_number') ? ' is-invalid' : '' }}"
                           placeholder="@lang('repair::launch.placeholder.document_number')"
            ...
            <div class="form-row">
                <div class="col mb-3">
                    <label for="document_who">@lang('repair::launch.document_who')</label>
                    <input type="text" name="document_who" id="document_who"
                           class="form-control{{ $errors->has('document_who') ? ' is-invalid' : '' }}"
                           placeholder="@lang('repair::launch.placeholder.document_who')"
            ...
            <div class="form-row">
                <div class="col mb-3">
                    <label for="document_date">@lang('repair::launch.document_date')</label>
                    <input type="date" name="document_date" id="document_date"
                           class="form-control{{ $errors->has('document_date') ? ' is-invalid' : '' }}"
                           placeholder="@lang('repair::launch.placeholder.document_date')"
