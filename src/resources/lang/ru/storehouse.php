...
return [
	...
	'error' => [
		...
		'upload' => [
			...
			'sku_duplicate_found' => 'Артикул :sku - найден дубликат в номенклатуре :offer_id',
			'quantity_not_exist' => 'Артикул :sku - не указано количество',
			'quantity_not_integer' => 'Артикул :sku - количество должно быть целым числом',
			'quantity_not_positive' => 'Артикул :sku - количество должно быть целым положительным числом',
