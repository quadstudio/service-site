...
return [
    ...
    'allow_parts'     => 'Учитывать стоимость запчастей',
    ...
    'help'            => [
        'serial'      => '<b class="text-danger">Внимание!</b> Перед заполнением акта настоятельно рекомендуем проверить серийный номер на наличие в нашей базе данных',
